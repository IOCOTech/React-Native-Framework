  ...
  return (
    <Container paddingHorizontal={theme.spacing.f4} flex={1} backgroundColor={theme.app.color.primary}>
      <ScrollView style={{flexGrow: 1}} showsVerticalScrollIndicator={false}>
        ...
        <Button theme={theme} title={"light theme"} action={() => setAppTheme(THEME.LIGHT)}/>
        <Spacer theme={theme} small/>
        ...
        <Spacer theme={theme} small/>
        <StyledText theme={theme} style={{fontSize: 18}} primary bold>bold</StyledText>
        <StyledText theme={theme} style={{fontSize: 18}} primary medium>medium</StyledText>
        <StyledText theme={theme} style={{fontSize: 18}} primary regular>regular</StyledText>
        <StyledText theme={theme} style={{fontSize: 18}} primary thin>thin</StyledText>
        <Spacer theme={theme} large/>
        <Text style={styles.lableStyle}>Font Size</Text>
        <Spacer theme={theme} small/>
        <StyledText theme={theme} f10 primary medium>f10 Size ({theme.font.size.f10})</StyledText>
        <StyledText theme={theme} f9 primary medium>f9 Size ({theme.font.size.f9})</StyledText>
        <StyledText theme={theme} f8 primary medium>f8 Size ({theme.font.size.f8})</StyledText>
        <StyledText theme={theme} f7 primary medium>f7 Size ({theme.font.size.f7})</StyledText>
        <StyledText theme={theme} f6 primary medium>f6 Size ({theme.font.size.f6})</StyledText>
        <StyledText theme={theme} f5 primary medium>f5 Size ({theme.font.size.f5})</StyledText>
        <StyledText theme={theme} f4 primary medium>f4 Size ({theme.font.size.f4})</StyledText>
        <StyledText theme={theme} f3 primary medium>f3 Size ({theme.font.size.f3})</StyledText>
        <StyledText theme={theme} f2 primary medium>f2 Size ({theme.font.size.f2})</StyledText>
        <StyledText theme={theme} f1 primary medium>f1 Size ({theme.font.size.f1})</StyledText>
        <Spacer theme={theme} large/>
        ...
        <Container flexDirection={"row"} justifyContent={"space-between"} align={"center"}>
          <Container alignItems={"center"} justifyContent={"flex-end"}>
            <Icon name="user" color={theme.icon.color.primary} size={theme.icon.size.f1} />
            <Text style={{fontFamily: theme.font.family.bold, fontSize: 14, color: "white"}}>.size.f1 ({theme.icon.size.f1})</Text>
          </Container>
          <Container alignItems={"center"} justifyContent={"flex-end"}>
            <Icon name="user" color={theme.icon.color.primary} size={theme.icon.size.f2} />
            <Text style={{fontFamily: theme.font.family.bold, fontSize: 14, color: "white"}}>.size.f2 ({theme.icon.size.f2})</Text>
          </Container>
          <Container alignItems={"center"} justifyContent={"flex-end"}>
            <Icon name="user" color={theme.icon.color.primary} size={theme.icon.size.f3} />
        ...
        <Container flexDirection={"row"} justifyContent={"space-between"} align={"center"}>
          <Container alignItems={"center"} justifyContent={"flex-end"}>
            <Icon name="user" color={theme.icon.color.primary} size={theme.icon.size.f4} />
            <Text style={{fontFamily: theme.font.family.bold, fontSize: 14, color: "white"}}>.size.f4 ({theme.icon.size.f4})</Text>
          </Container>
          <Container alignItems={"center"} justifyContent={"flex-end"}>
            <Icon name="user" color={theme.icon.color.primary} size={theme.icon.size.f5} />
            <Text style={{fontFamily: theme.font.family.bold, fontSize: 14, color: "white"}}>.size.f5 ({theme.icon.size.f5})</Text>
          </Container>
          <Container alignItems={"center"} justifyContent={"flex-end"}>
            <Icon name="user" color={theme.icon.color.primary} size={theme.icon.size.f6} />
        ...
        <Container flexDirection={"row"} justifyContent={"space-between"} align={"center"}>
          <Container alignItems={"center"} justifyContent={"flex-end"}>
            <Icon name="user" color={theme.icon.color.primary} size={theme.icon.size.f7} />
            <Text style={{fontFamily: theme.font.family.bold, fontSize: 14, color: "white"}}>.size.f7 ({theme.icon.size.f7})</Text>
          </Container>
          <Container alignItems={"center"} justifyContent={"flex-end"}>
            <Icon name="user" color={theme.icon.color.primary} size={theme.icon.size.f8} />
            <Text style={{fontFamily: theme.font.family.bold, fontSize: 14, color: "white"}}>.size.f8 ({theme.icon.size.f8})</Text>
          </Container>
          <Container alignItems={"center"} justifyContent={"flex-end"}>
            <Icon name="user" color={theme.icon.color.primary} size={theme.icon.size.f9} />
        ...
        <Container flexDirection={"row"} justifyContent={"space-between"} align={"center"}>
          <Container alignItems={"center"} justifyContent={"flex-end"}>
            <Icon name="user" color={theme.icon.color.primary} size={theme.icon.size.f10} />
        ...
        <Spacer theme={theme} small/>
        <Container containerStyles={{borderColor: theme.border.color.primary, borderWidth: 1, padding: 5}} backgroundColor={theme.app.color.primary} alignItems={"center"} justifyContent={"center"} marginTop={5}>
           <Text style={{fontSize: 18, color: "white"}}>primary</Text>
        </Container>
        <Container containerStyles={{borderColor: theme.border.color.primary, borderWidth: 1, padding: 5}} backgroundColor={theme.app.color.secondary} alignItems={"center"} justifyContent={"center"} marginTop={5}>
           <Text style={{fontSize: 18, color: "white"}}>secondary</Text>
        </Container>
        <Container containerStyles={{borderColor: theme.border.color.primary, borderWidth: 1, padding: 5}} backgroundColor={theme.app.color.accent} alignItems={"center"} justifyContent={"center"} marginTop={5}>
           <Text style={{fontSize: 18, color: "black"}}>accent</Text>
        </Container>
        <Container containerStyles={{borderColor: theme.border.color.primary, borderWidth: 1, padding: 5}} backgroundColor={theme.app.color.offWhite} alignItems={"center"} justifyContent={"center"} marginTop={5}>
           <Text style={{fontSize: 18, color: "black"}}>offWhite</Text>
        </Container>
        <Container containerStyles={{borderColor: theme.border.color.primary, borderWidth: 1, padding: 5}} backgroundColor={theme.app.color.white} alignItems={"center"} justifyContent={"center"} marginTop={5}>
           <Text style={{fontSize: 18, color: "black"}}>white</Text>
        </Container>
        <Container containerStyles={{borderColor: theme.border.color.primary, borderWidth: 1, padding: 5}} backgroundColor={theme.app.color.black} alignItems={"center"} justifyContent={"center"} marginTop={5}>
           <Text style={{fontSize: 18, color: "white"}}>black</Text>
        </Container>
        <Container containerStyles={{borderColor: theme.border.color.primary, borderWidth: 1, padding: 5}} backgroundColor={theme.app.color.grey} alignItems={"center"} justifyContent={"center"} marginTop={5}>
           <Text style={{fontSize: 18, color: "white"}}>grey</Text>
        </Container>
        <Container containerStyles={{borderColor: theme.border.color.primary, borderWidth: 1, padding: 5}} backgroundColor={theme.app.color.success} alignItems={"center"} justifyContent={"center"} marginTop={5}>
           <Text style={{fontSize: 18, color: "black"}}>success</Text>
        </Container>
        <Container containerStyles={{borderColor: theme.border.color.primary, borderWidth: 1, padding: 5}} backgroundColor={theme.app.color.warning} alignItems={"center"} justifyContent={"center"} marginTop={5}>
           <Text style={{fontSize: 18, color: "white"}}>warning</Text>
        </Container>
        <Container containerStyles={{borderColor: theme.border.color.primary, borderWidth: 1, padding: 5}} backgroundColor={theme.app.color.error} alignItems={"center"} justifyContent={"center"} marginTop={5}>
